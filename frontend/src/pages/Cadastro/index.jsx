...
const Cadastro = () => {
  ...
  const handleCadastro = async (e) => {
    ...
    if (!aceitouTermos) { toast.warn("Você precisa aceitar os termos de uso!"); return; }
    setCarregando(true);
    try {
      const response = await api.post('/api/cadastro', {
        nome: `${nome} ${sobrenome}`, email, telefone, senha
      });
      ...
      <section className="painel-rg">
        ...
        <section className="rg-nome-row">
          <section className="rg-i-email">
            ...
            <label>
              <span style={{ transitionDelay: '0ms' }}>N</span><span style={{ transitionDelay: '50ms' }}>o</span>
              <span style={{ transitionDelay: '100ms' }}>m</span><span style={{ transitionDelay: '150ms' }}>e</span>
            </label>
          </section>
          <section className="rg-i-email">
            <input type="text" required value={sobrenome} onChange={(e) => setSobrenome(e.target.value)} />
            <label>
              <span style={{ transitionDelay: '0ms' }}>S</span><span style={{ transitionDelay: '50ms' }}>o</span>
              <span style={{ transitionDelay: '100ms' }}>b</span><span style={{ transitionDelay: '150ms' }}>r</span>
              <span style={{ transitionDelay: '200ms' }}>e</span><span style={{ transitionDelay: '250ms' }}>n</span>
              <span style={{ transitionDelay: '300ms' }}>o</span><span style={{ transitionDelay: '350ms' }}>m</span>
        ...
        <section className="rg-i-email">
          ...
          <label>
            <span style={{ transitionDelay: '0ms' }}>E</span><span style={{ transitionDelay: '50ms' }}>m</span>
            <span style={{ transitionDelay: '100ms' }}>a</span><span style={{ transitionDelay: '150ms' }}>i</span>
        ...
        <section className="rg-i-tel">
          ...
          <label>
            <span style={{ transitionDelay: '0ms' }}>T</span><span style={{ transitionDelay: '50ms' }}>e</span>
            <span style={{ transitionDelay: '100ms' }}>l</span><span style={{ transitionDelay: '150ms' }}>e</span>
            <span style={{ transitionDelay: '200ms' }}>f</span><span style={{ transitionDelay: '250ms' }}>o</span>
            <span style={{ transitionDelay: '300ms' }}>n</span><span style={{ transitionDelay: '350ms' }}>e</span>
          </label>
        </section>
        <section className="rg-senhas-row">
          <section className="rg-i-senha">
            ...
            <label>
              <span style={{ transitionDelay: '0ms' }}>S</span><span style={{ transitionDelay: '50ms' }}>e</span>
              <span style={{ transitionDelay: '100ms' }}>n</span><span style={{ transitionDelay: '150ms' }}>h</span>
          ...
          <section className="rg-i-senha">
            ...
            <label>
              <span style={{ transitionDelay: '0ms' }}>C</span><span style={{ transitionDelay: '50ms' }}>o</span>
              <span style={{ transitionDelay: '100ms' }}>n</span><span style={{ transitionDelay: '150ms' }}>f</span>
              <span style={{ transitionDelay: '200ms' }}>i</span><span style={{ transitionDelay: '250ms' }}>r</span>
              <span style={{ transitionDelay: '300ms' }}>m</span><span style={{ transitionDelay: '350ms' }}>a</span>
        ...
        <section className="rg-termos">
          <label className="rg-termos-label">
            ...
            <span className="rg-termos-texto">Eu li e aceito os <a href="#" onClick={(e) => e.preventDefault()} className="rg-termos-link">Termos de Uso</a></span>
          </label>
        </section>
